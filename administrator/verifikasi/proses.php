...
$query = "SELECT p.id_pengaduan as id_pengaduan, m.nama as nama, p.tgl_pengaduan as tgl_pengaduan, p.foto as foto, p.isi_laporan as isi_laporan, p.status as status FROM pengaduan p JOIN masyarakat m where p.nik = m.nik AND p.status = 'proses';";
...
<head>
    ...
    <title>Pengaduan Telah Sedang diProses</title>
